...
**Status: the Vercel app is connected to the designated Supabase test backend.** Core deployed request, messaging, scheduling, upload and access-boundary checks pass. Email, real-device and production acceptance remain pending. No real invitations, email deliveries, production launch, DNS changes, or marketing-site changes have been made.
